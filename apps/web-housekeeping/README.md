...
Housekeeping Dashboard (Pack #4) web-first implementation.
...
## Notes
- Branded with sealed Meshva colors from official logo.
- UI is structured for Pack #4 workflows and API wiring.
