...
const ERROR_CODE_MESSAGE_MAP: Record<string, string> = {
  ...
  AUTH_ORIGIN_INVALID: 'Security check failed. Open the portal from an approved origin.',
  AUTH_IDENTIFIER_IN_USE: 'An account already exists with this identifier.',
  AUTH_TENANT_SUSPENDED: 'Organization account is suspended. Contact support.',
  AUTH_ACCOUNT_DISABLED: 'Account disabled. Contact support.',
