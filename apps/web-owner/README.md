...
Owner Console (Pack #5) multi-property web-first implementation.
...
## Notes
- Read-only oversight and export-focused UX.
- Uses sealed Meshva brand color system from official logo.
